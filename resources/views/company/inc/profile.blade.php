...
<div class="row">
  <div class="col-md-6">
    <div class="formrow"> {{ ImgUploader::print_image("company_logos/$company->logo", 75, 75) }} </div>
  </div>
  <div class="col-md-6">
    <div class="formrow">
...
<div class="row">
  ...
  <div class="col-md-4">
    <div class="formrow {!! APFrmErrHelp::hasError($errors, 'ceo') !!}"> {!! Form::text('ceo', null, array('class'=>'form-control', 'id'=>'ceo', 'placeholder'=>__('Designation'))) !!}
      {!! APFrmErrHelp::showErrors($errors, 'ceo') !!} </div>
  </div>
  <div class="col-md-4">
    <div class="formrow {!! APFrmErrHelp::hasError($errors, 'location') !!}"> {!! Form::text('location', null, array('class'=>'form-control', 'id'=>'location', 'placeholder'=>__('Contact Person Name'))) !!}
  ...
  <div class="col-md-6">
    <div class="formrow {!! APFrmErrHelp::hasError($errors, 'fax') !!}"> {!! Form::text('fax', null, array('class'=>'form-control', 'id'=>'fax', 'placeholder'=>__('Whats App Number'))) !!}
  ...
  <div class="col-md-4">
    <div class="formrow {!! APFrmErrHelp::hasError($errors, 'pinterest') !!}"> {!! Form::text('pinterest', null, array('class'=>'form-control', 'id'=>'pinterest', 'placeholder'=>__('Instagram'))) !!}
