...
<div class="page-content-wrapper"> 
    ...
    <div class="page-content"> 
        ...
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">Manage Roles <small>Roles</small> </h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">Roles</span> </div>
                        <div class="actions"> <a href="{{ route('create.role') }}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-plus"></i> Add New Role</a> </div>
                    </div>
                    <div class="portlet-body">
                        <div class="table-container">
                            <form method="post" role="form" id="role-search-form">
                                <table class="table table-striped table-bordered table-hover"  id="roleDatatableAjax">
                                    <thead>
                                        <tr role="row" class="filter">
                                            <td>{!! Form::select('lang', ['' => 'Select Language']+$languages, config('default_lang'), array('id'=>'lang', 'class'=>'form-control')) !!}</td>
                                            <td>
                                           </td>
                                            <td><input type="text" class="form-control" name="role" id="role" autocomplete="off" placeholder="Role"></td>
    ...
    $(function () {
        var oTable = $('#roleDatatableAjax').DataTable({
            ...
            ajax: {
                ...
                {data: 'lang', name: 'lang'},
                {data: 'role', name: 'role'},
                {data: 'functional_area_id', name: 'functional_area_id'},
