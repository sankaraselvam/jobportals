<h5 id="cvs" onclick="showCvs();">{{__('Attach Resume')}}</h5>
...
<div class="row">
  ...
  <a href="javascript:;" onclick="showProfileCvModal();" style="background: #18a7ff;
    color: #fff;
    padding: 10px;font-size: 16px;"> {{__('Update Resume')}} </a>
<hr>
