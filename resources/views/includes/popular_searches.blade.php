		...
		<div class="topsearchwrap">
			<div class="col-md-6">	
				...
				<ul class="row catelist">
					...
					<li class="col-md-6 col-sm-6"><a href="{{route('job.list', ['functional_area_id[]'=>$functionalArea->functional_area_id])}}" title="{{$functionalArea->functional_area}}">{{$functionalArea->functional_area}} <span>({{$functional_area_id_num_jobs->num_jobs}})</span></a>
					</li>
			...
			<div class="col-md-6">	
				...
				<ul class="row catelist">
					...
					<li class="col-md-6 col-sm-4 col-xs-6"><a href="{{route('job.list', ['city_id[]'=>$city->city_id])}}" title="{{$city->city}}">{{$city->city}} <span>({{$city_id_num_jobs->num_jobs}})</span></a>
					</li>
			...
			<div class="col-md-12">	
				...
				<ul class="row catelist">					
					...
					<li class="col-md-3 col-sm-6"><a href="{{route('job.list', ['industry_id[]'=>$industry->industry_id])}}" title="{{$industry->industry}}">{{$industry->industry}} <span>({{$num_jobs}})</span></a>
					</li>
