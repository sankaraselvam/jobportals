    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <a href="{{ route('list.states') }}">Role</a> <i class="fa fa-circle"></i> </li>
            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">          
                        ...
                        {!! Form::model($role, array('method' => 'put', 'route' => array('update.state', $role->id), 'class' => 'form', 'files'=>true)) !!}
                        {!! Form::hidden('id', $role->id) !!}            
                        <div class="tab-content">              
                            <div class="tab-pane fade active in" id="Details"> @include('admin.role.forms.form') </div>
                        </div>
                        {!! Form::close() !!}
                    </div>
                </div>
