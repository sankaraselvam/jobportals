    ...
    <div class="col-lg-6">
        <div class="candidates-skills">
            <div class="candidates-skills-info">
                <span class="d-block" style="color: #fff;"><i class="fa fa-map-marker" aria-hidden="true"></i> <span style="margin-left: 3px;"> {{ isset($user->city)?$user->city->city:'' }} , {{ isset($user->country)?$user->country->country:'' }}</span> </span>
                </span>
                <span class="d-block mt-2" style="color: #fff;"><i class="fa fa-suitcase" aria-hidden="true"></i> <span style="margin-left: 3px;">{{ isset($user->profileCarrer->jobrole)?$user->profileCarrer->jobrole->role:'' }}</span></span>
            </div>
        </div>
    </div>
    <div class="col-lg-6">
