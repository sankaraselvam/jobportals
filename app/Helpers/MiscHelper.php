...
class MiscHelper
{
    ...
    {
        $array = array();
        for ($counter = date('Y'); $counter > 1950; $counter--) {
            $array[$counter] = $counter;
        }
    ...
    public static function getSalaryLakhs()
    {
        $array = array();
    ...
    public static function getSalaryThousands()
    {
        $array = ['0' => '0', '5' => '5', '10' => '10', '15' => '15', '20' => '20', '25' => '25', '30' => '30', '35' => '35', '40' => '40', '45' => '45', '50' => '50', '55' => '55', '60' => '60', '65' => '65', '70' => '70', '75' => '75', '80' => '80', '85' => '85', '90' => '90', '95' => '95'];
